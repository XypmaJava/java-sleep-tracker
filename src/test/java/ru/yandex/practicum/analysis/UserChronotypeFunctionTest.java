    ...
    void shouldClassifyLark() {
        SleepingSession night1 =
                new SleepingSession(LocalDateTime.of(2025, 10, 1, 21, 0),
                        LocalDateTime.of(2025, 10, 2, 6, 30), SleepQuality.NORMAL);
        Chronotype result = function.apply(List.of(night1));
    ...
    void shouldClassifyDoveWhenMixedOrTie() {
        SleepingSession night1 =
                new SleepingSession(LocalDateTime.of(2025, 10, 1, 22, 30),
                        LocalDateTime.of(2025, 10, 2, 8, 0), SleepQuality.NORMAL);
        SleepingSession night2 =
                new SleepingSession(LocalDateTime.of(2025, 10, 2, 23, 15),
                        LocalDateTime.of(2025, 10, 3, 9, 0), SleepQuality.GOOD);
